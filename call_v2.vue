    ...
    <div class="mb-6">
      <div class="flex flex-wrap justify-between items-center gap-4 mb-4">
        ...
        <div class="flex gap-2">
          ...
          <button class="px-4 py-2 bg-red-600 hover:bg-red-700 rounded disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      <div class="lg:col-span-1 flex flex-col">
          ...
          <div class="bg-gray-800 rounded-lg overflow-hidden">
            <div class="p-3 bg-gray-700 flex justify-between items-center">
              ...
              <div class="flex items-center space-x-2">
                <div class="text-xs px-2 py-1 rounded" :class="isCameraOn ? 'bg-green-900' : 'bg-red-900'">
                  {{ isCameraOn ? '📹 BẬT' : '📹 TẮT' }}
                </div>
                <div class="text-xs px-2 py-1 rounded" :class="isMicOn ? 'bg-green-900' : 'bg-red-900'">
                  {{ isMicOn ? '🎤 BẬT' : '🎤 TẮT' }}
                </div>
              </div>
            </div>
        ...
        <div class="max-lg:order-first bg-gray-800 rounded-lg overflow-hidden mb-6">
          ...
          <div class="p-3 max-h-96 overflow-y-auto">
                ...
                <div class="flex items-center">
                  ...
                  <div>
                    ...
                    <div class="text-xs text-gray-400 flex items-center">
                      ...
                      <span v-if="userAudioLevels[userRoom.id]! > 0.1 && userRoom.isOnline" class="ml-2 text-green-400">
                        🔊 Speaking
                      </span>
                    </div>
                  </div>
            ...
            <!-- Empty State -->
            <!-- <div v-if="!otherUsers || otherUsers.length === 0" class="text-center py-8 text-gray-400">
              <div class="text-4xl mb-2">
                👤
              </div>
              <p class="text-sm">Chưa có người dùng nào tham gia</p>
            ...
            <div class="p-4">
                ...
                <div class="text-center">
                  ...
                  <p class="text-sm mt-1">
                    <span v-if="otherUsers && otherUsers.length > 0">
                      {{otherUsers.filter(u => u.isOnline).length}} người dùng trực tuyến
                    </span>
                    <span v-else>
                      Chia sẻ liên kết phòng để mời người khác
                    </span>
                  </p>
                </div>
              </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div v-for="video in remoteVideos" :key="video.userId"
                  ...
                  <!-- Audio Indicator -->
                  <div v-if="userAudioLevels[video.userId]! > 0.05" class="absolute top-2 right-2">
                    <div class="flex space-x-0.5">
                      <div v-for="n in 3" :key="n" class="w-1 h-3 rounded bg-green-500" :style="{
...
import { stunSeverDefault } from '../../../../../app/utils/stunSeverDefault'
